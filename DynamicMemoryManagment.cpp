...
void deleteDynamicArray(point* objectToDelete)
{
	delete[] objectToDelete;
}

void replaceDynamicArray(point* destination, const point* source, const int sizeOfBothArrays)
{
...
void copyDynamicArray(point* destination, const point* source, const int sizeOfBothArrays)
{
...
point* insertObjectIntoArray(std::pair<point, const int> objectToInsertAtPosition, std::pair<point*, const int> arrayToBeInsertedInWithItsSize)
{
...
bool isNullptr(const point* pointToCheck)
{
